...
class BasicApp(QMainWindow):
    ...
    def process_excel_file(self, file_path):
        try:
            ...
            # Verificar que existan hojas 'ON' y 'OFF'
            if not self.on_sheets and not self.off_sheets:
                raise ValueError("No se encontraron hojas 'ON' o 'OFF' en el archivo.")
    ...
    def display_initial_sheets(self):
        # Mostrar la primera hoja "on" y "off" en sus respectivas pestañas
        if self.on_sheets:
