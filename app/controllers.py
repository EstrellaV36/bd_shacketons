...
class Controller:
    ...
    def load_existing_data(self, selected_city: str):
        try:
            ...
            # Cargar ETA para tripulantes filtrando por ciudad
            eta_records = self.db_session.query(EtaCiudad).filter(EtaCiudad.ciudad == selected_city_code).all()
            ...
            eta_vuelo_df_on = pd.DataFrame([{
                ...
                'City': eta.ciudad,  # Se mantiene este valor
                'ETA': eta.eta
